...
var FFMpeg = function(options) {
	...
	this.timeoutRestart = options.timeoutRestart
...
FFMpeg.prototype.start = function() {
	...
	this.child.stderr.on('data', this.emit.bind(this, 'error'));
	...
	this.child.on('close', function(code) {
		if (code === 0 || code === 1) {
			setTimeout(FFMpeg.prototype.start.bind(this), this.timeoutRestart);
		}
	}.bind(this));
